...
import { UserDataApiResponse } from "../../../../types/getAllUser";
import { ToastContainer, toast } from "react-toastify";
import { admingetblockeduser } from "../../../../features/axios/api/admin/admingetBlockeduser";
...
const UserTable: React.FC = () => {
  ...
  useEffect(() => {
    const getUsers = async () => {
      const data: any = await admingetblockeduser();
