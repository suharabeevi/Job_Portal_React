...
const conversationDbRepository_1 = require("../../../application/repositories/conversationDbRepository");
...
const conversationRouter = () => {
    ...
    route.get('/:id', AuthenticationMiddleware_1.default, controller.findConversation);
    return route;
};
